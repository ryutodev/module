...
#define PlayerController Object
struct csharparray{
...
ImVec2 world2screen_c(Vector3 pos, bool &checker, bool fixpos = false) {
	static auto cam = (void*(*)())(getAbsoluteAddress("libil2cpp.so",0x2AC2AD0));
	auto camera = cam();
	static auto WorldToScreenPoint =(Vector3(*)(void*,Vector3))(getAbsoluteAddress("libil2cpp.so",0x2AC2744));
