...
#define ALIGNAS(byte_alignment)
    ...
    */
    ...
    inline static void decodePrefixedChar(
            bool isPrefixed, char* prefixed,
...
namespace Json {
    ...
    */
    ...
    char Value::asChar() const {
        JSON_ASSERT_MESSAGE(type_ == stringValue,
                            "in Json::Value::asChar(): requires stringValue");
        if (value_.string_ == 0) return 0;
        unsigned this_len;
        char this_str;
        decodePrefixedChar(this->allocated_, this->value_.string_, &this_len, &this_str);
        return this_str;
    }
